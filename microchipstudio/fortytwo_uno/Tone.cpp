...
#define WAIT_TC16_REGS_SYNC(x) while(x->COUNT16.SYNCBUSY.bit.STATUS);
...
/* TC5 does not exist on some SAMC21s. Using TC1 instead. */
#define TONE_TC         TC1
#define TONE_TC_IRQn    TC1_IRQn
#define TONE_TC_TOP     0xFFFF
#define TONE_TC_CHANNEL 0

#if defined(__SAMC21N18A__) || defined(__SAMC21N17A__)
void INT21_Handler (void) __attribute__ ((weak, alias("Tone_Handler")));
#else
